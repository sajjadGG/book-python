...
Note, that the following line is only for testing purposes, and you should not do that in your programs.
This assumes, that user will input str ``Mark Watney``:

>>> input = lambda x: 'Mark Watney'  # Assume user will input 'Mark Watney' and then hit ENTER key

Typically you ask user for input, as follows:
...
>>> input = lambda x: '42'  # Assume user will input '42' and then hit ENTER key
...
>>> input = lambda x: '42.5'  # Assume user will input '42' and then hit ENTER key
>>> age = input('What is your age: ')
>>>
>>> age = int(age)
Traceback (most recent call last):
...
>>> input = lambda x: '42,5'  # Assume user will input '42,5' and then hit ENTER key
>>> age = input('What is your age: ')
>>>
>>> age = int(age)
Traceback (most recent call last):
