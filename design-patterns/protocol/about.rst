...
MutableSequence      Sequence                   ``__getitem__``, Inherited Sequence methods,
                                                ...
                                                ``__delitem__``, ``remove``, ``__iadd__``, ``__len__``, ``insert``
...
Set                  Collection                 ``__contains__``, ``__le__``, ``__lt__``, ``__eq__``, ``__ne__``,
                                                ...
                                                ``__len__``, ``__sub__``, ``__xor__``, ``isdisjoint``
MutableSet           Set                        ``__contains__``, Inherited Set methods,
                                                ``__iter__``, ``clear``, ``pop``, ``remove``, ``__ior__``,
                                                ``__len__``, ``__iand__``, ``__ixor__``, ``__isub__``, ``add``, ``discard``
Mapping              Collection                 ``__getitem__``, ``__contains__``, ``keys``, ``items``, ``values``,
                                                ``__iter__``, ``get``, ``__eq__``, ``__ne__``, ``__len__``
MutableMapping       Mapping                    ``__getitem__``, Inherited Mapping methods,
                                                ``__setitem__``, ``pop``, ``popitem``, ``clear``, ``update``,
                                                ``__delitem__``, ``setdefault``, ``__iter__``, ``__len__``
