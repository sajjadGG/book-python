...
addressbook = [
    Contact(first_name='Matt', last_name='Kowalski', addresses=(
        ...
        Address(street='', city='Kennedy Space Center', zipcode='32899', country='USA'),
        Address(street='4800 Oak Grove Dr', city='Pasadena', zipcode='91109', country='USA'),
...
output = json.dumps(addressbook, cls=JSONEncoder)
