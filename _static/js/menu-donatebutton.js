const DONATE = `<div id="donate">
    ...
    <input type="image" src="https://pics.paypal.com/00/s/MTMzMzMyMDItYTU2Ny00OWJlLTk0YzQtYWRmYjY2OGEzMTc4/file.PNG" border="0" name="submit" title="PayPal - The safer, easier way to pay online!" alt="Donate with PayPal button" />
    </form>
    </div>`;
