...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AlterField(
            model_name='iris',
            name='species',
            field=models.CharField(choices=[('setosa', 'Iris Setosa'), ('virginica', 'Iris Virginica'), ('versicolor', 'Iris Versicolor')], help_text='wybierz jedno z nich', max_length=30, verbose_name='Species'),
        ),
    ]
