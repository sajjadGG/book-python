...
class User:
    ...
    born: date = Column(Date)
    last_login: datetime = Column(DateTime)
    is_active: bool = Column(Boolean)
    is_staff: bool = Column(Boolean)
    is_superuser: bool = Column(Boolean)
    user_permissions: list[Permission] = relationship('Permission', backref='user')
