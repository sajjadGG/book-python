...
from sqlalchemy import String, Integer, Date, BigInteger, Numeric


Model = MetaData()


product = Table('products', Model,
    Column('id', Integer, primary_key=True),
    Column('ean13', BigInteger, nullable=False, unique=True),
    Column('name', String(50), nullable=False, unique=False),
    Column('price', Numeric(3,2), nullable=False),
)

order = Table('orders', Model,
    Column('id', Integer, primary_key=True),
