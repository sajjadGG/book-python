...
class Address(DatabaseModel):
    ...
    street: str | None = Column(String, nullable=True)
    city: str = Column(String)
    post_code: int | None = Column(Integer, nullable=True)
...
class Astronaut(DatabaseModel):
    ...
    firstname: str
    lastname: str
    addresses: list[Address] = relationship('Address', backref='astronaut')
